<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userprofileview.aspx.cs" Inherits="Library_Management.userprofileview" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    ...
                                    <asp:Label ID="Label1" cssClass="badge badge-pill badge-secondary" runat="server" Text="Your Status"></asp:Label>
                                </center>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox cssClass="form-control" ID="TextBox5" runat="server" placeholder="Pin Code" TextMode="Number"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                            <center>
                                <span class="badge badge-pill badge-info my-2">Login Credentials</span>
                            </center>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-8 mx-auto">
                                <center>
                                    <div class="form-group">
                                        <asp:Button CssClass="btn btn-block btn-success btn-lg" ID="Button1" runat="server" Text="Update" OnClick="Button1_Click" />
                                    </div>
                                </center>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img src="images/icon1.jpg" width="100" class="rounded"/>
                                </center>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                            <asp:GridView ID="GridView1" CssClass="table table-responsive-lg table-responsive-md table-responsive-sm" runat="server" AutoGenerateColumns="False" DataKeyNames="member_id,book_id" OnRowDataBound="GridView1_RowDataBound">
                                <Columns>
                                    <asp:BoundField DataField="member_id" HeaderText="Memeber Id" ReadOnly="True" SortExpression="member_id" />
